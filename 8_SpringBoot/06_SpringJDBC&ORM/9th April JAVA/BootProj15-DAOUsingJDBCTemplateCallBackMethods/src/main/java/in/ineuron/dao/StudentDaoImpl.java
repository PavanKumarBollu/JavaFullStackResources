...
public class StudentDaoImpl implements IStudentDao {
	...
	public List<StudentBO> fetchStudentByCitites(String city1, String city2, String city3) {
		 ...
		 * 
		 * @Override public List<StudentBO> extractData(ResultSet rs) throws SQLException, DataAccessException { 
		...
		jdbcTemplate.query(GET_STUDENT_BY_CITY, new RowCallbackHandler() {
			...
			public void processRow(ResultSet rs) throws SQLException {
				System.out.println(	"StudentDaoImpl.fetchStudentByCitites(...).new RowCallbackHandler() {...}.processRow()");
